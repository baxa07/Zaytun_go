...
export type MapProviderErrorCode='MISSING_CONFIG'|'CORE_LOAD_FAILED'|'READY_TIMEOUT'|'READY_FAILED'|'MAP_CONTAINER_INVALID'|'MAP_INIT_FAILED'|'SEARCH_CONFIG_MISSING'|'SUGGEST_CONFIG_MISSING'|'SEARCH_FAILED'|'SUGGEST_FAILED'|'REVERSE_GEOCODING_FAILED'|'GEOCODING_FAILED'|'NO_RESULTS'|'UNAVAILABLE'
