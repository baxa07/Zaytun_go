...
export default defineConfig({
  testDir: "./e2e",
  testMatch: ["auth-local.spec.ts", "customer-otp.spec.ts", "checkout-idempotency.spec.ts", "live-restaurant-board.spec.ts", "order-history.spec.ts", "driver-ledger.spec.ts"],
  fullyParallel: false,
  workers: 1,
  retries: 0,
  reporter: [["list"]],
