...
const payload={customer:{name:'Integration Customer',primaryPhone:'+998 90 000 00 00'},type:'DELIVERY',paymentMethod:'CASH',deliveryFee:999999,specialInstructions:'Integration test',address:{district:'Navoiy shahar',street:'Test ko‘chasi',house:'10',landmark:'Test maktabi',deliveryNotes:'Qo‘ng‘iroq qiling',latitude:40.1039,longitude:65.3688,confidence:'COMPLETE',pinConfirmedAt:new Date().toISOString(),locationProvider:'mock'},items:[{menuItemId:'plov',name:'Navoiy oshi',unitPrice:48000,quantity:1,modifierIds:[],modifierNames:[],instructions:''}]}
